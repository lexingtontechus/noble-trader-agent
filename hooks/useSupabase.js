...
export function useSupabase() {
  ...
  const saveCalculation = useCallback(async ({ params, result, markovProbs }) => {
  ...
  const fetchSessionLog = useCallback(async ({ page = 1 } = {}) => {
  ...
  const fetchFactorById = useCallback(async (id) => {
  ...
  return { saveCalculation, fetchSessionLog, fetchFactorById, PAGE_SIZE }
}
